 ...
 */
class AdminModule extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['u_id', 'r_id', 'r_name', 'm_id', 'm_name', 'm_link_url', 'p_id', 'p_name', 'p_module_code'], 'required'],
            [['m_is_menu'], 'boolean'],
            [['m_rank'], 'number'],
            [['u_id', 'r_id', 'm_id', 'p_id'], 'string', 'max' => 32],
